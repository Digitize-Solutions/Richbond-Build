import { METADATA_RESERVED, ATTRIBUTE_TYPES, SORT_OPTIONS } from './constants';
...
export const prepAttributeForComponent = (
  ...
  if (attribute.type === ATTRIBUTE_TYPES.arraySelector) {
    ...
    console.log('Inside', attribute.values, sort);
    ...
    options = attribute.values
      ? attribute.values
          ...
          .sort((a, b) => {
            ...
            var asortorder=a?.metadata?._sort ? a?.metadata?._sort : 'Z';
            var bsortorder=b?.metadata?._sort ? b?.metadata?._sort : 'Z';
            console.log(asortorder,bsortorder);
